...
[0] = LAYOUT_65_ansi_blocker_splitbs(
  ...
  MO(2), KC_LALT, KC_LGUI,                   KC_SPC,                             KC_RALT, KC_RCTL,                   KC_LEFT, KC_DOWN, KC_RGHT),
...
[1] = LAYOUT_65_ansi_blocker_splitbs(
  ...
  KC_LCTL, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS, KC_BSPC, KC_PGDN, \
...
[2] = LAYOUT_65_ansi_blocker_splitbs(
  ...
  KC_LCTL, S(KC_A), S(KC_O), S(KC_E), S(KC_U), S(KC_I), S(KC_D), S(KC_H), S(KC_T), S(KC_N), S(KC_S), S(KC_MINS), S(KC_BSPC), KC_PGDN, \
  KC_TRNS, S(KC_QUOT), S(KC_Q), S(KC_J), S(KC_K), S(KC_X), S(KC_B), S(KC_M), S(KC_W), S(KC_V), S(KC_Z), MO(2), KC_UP, MO(3), \
  KC_TRNS, KC_LALT, KC_LGUI, KC_SPC, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
...
[3] = LAYOUT_65_ansi_blocker_splitbs(
  ...
  KC_TRNS, , LSFT(KC_MINS), LSFT(KC_6), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, \
  KC_TRNS, LSFT(KC_9), LSFT(KC_3), LSFT(KC_0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,          KC_TRNS, \
  KC_TRNS, LSFT(KC_5), LSFT(KC_8), LSFT(KC_5), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_PGUP, KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS,                   LSFT(KC_7),                            KC_TRNS, KC_TRNS,                   KC_HOME, KC_PGDN, KC_END),
};
